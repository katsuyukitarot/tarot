...
$(function () {
    ...
    var str = [
        //        [ "photo/000.JPG" ],
        ['今日はオープンな気分で過ごせそう。思い込みを捨てて、\
          \n何事も真剣に考えないようにしましょう。\
          \nイヤなことや苦手なことにも、好奇心を持って取組んでみて。\
          \n開放すれば、イキイキと楽しい日を過ごせるはず。\
          \n仕事や勉強は、全く違う方法を試してみましょう。\
          \nプライベートは、思い切り羽を伸ばして楽しんで!'
        ],
        //["photo/001.JPG"],
        ['もし私じゃなけれは、誰がやる？」「今じゃなければ、いつやる？」\
          \nそれが今日の開運ワードです。\
          \n今日のあなたには、目標を達成するための自信と集中力が備わっています。\
          \n周りの人達とのコミュニケーションを大切にし、\
          \n情報収集と準備をしっかりして挑みましょう。\
        ...
        //[ "photo/010.JPG" ],
        ['ワイルドな1日です。今日のあなたはエネルギーに満ちあふれ、\
          \n心の中が愛情と喜びでいっぱいになるでしょう。\
