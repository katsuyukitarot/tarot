...
$(function () {
    ...
    var str = [
        ...
        ['充実した活動をしたい1日です。\
          \n今日のあなたは十分なエネルギーに満ちあふれているので、やるべき事や、\
          \n長い間やってみたかった事などに、思い切ってトライしてみましょう。\
          \n特に仕事運が好調。技術と能力を発揮して、依頼や期待に応える事ができるはず。\
          \n不明瞭な事をクリアにし、未解決の仕事をやり遂げましょう。'
        ],
        //[ "photo/004.JPG" ],
        ['「信じる気持ち」を大切にしましょう。\
        ...
        //[ "photo/006.JPG" ],
        ['今日は新しいことが始まるスタートの日です。今まで保留にしていたことがあるなら、これ以上待つ必要はありません。\
          \n目の前で起こっている事に興味を持ち、よく観察しながら、目標に照準を合わせましょう。\
          \nいったん始めるとノンストップで進んでいくので、\
          \n大事な事を見落としていないか、事前によく確認しましょう。'
        ],
        //[ "photo/007.JPG" ],
        ['今日は頭をクリアにしましょう。\
        ...
        ['ワイルドな1日です。今日のあなたはエネルギーに満ちあふれ、心の中が愛情と喜びでいっぱいになるでしょう。\
          \nテンションも最高でビックリするほどパワフルに活動できそう。\
          \n大騒ぎした後は、パワーをクリエイティブな方向に転換しましょう。\
        ...
        //[ "photo/012.JPG" ]
        ['今日は何かが終わる日です。もし「それ」があなたにとって重要なことなら、終わらせるのに苦労するかもしれません。\
          \nでも、あなたは今日こそ「それ」とサヨナラするべきです。\
          \nそのままにしておいてはいけません。解放されて自由の身になったとき、\
    ...
    $("#btn3").on("click", function () {
        ...
        $("#tarot").text(num); // div領域を隠す
        //$("#tarot_photo").attr; // div領域を隠す
        $(".tarot_photo").attr({ 'src': num }); // div領域を隠す
        $("#tarot_str").text(str[index]); // div領域を隠す
